 ...
 */
public class DBRepository implements IRepository<Integer, Motociclist> {
    private JdbcUtils dbUtils;

    public DBRepository(Properties props){
    ...
    public void delete(Integer integer) {
        Connection con=dbUtils.getConnection();
        try(PreparedStatement preStmt=con.prepareStatement("delete from Motociclist where id=?")){
